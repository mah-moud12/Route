...
namespace Data01
{
    public static class ListGeneratorHelpers
    {
        public static List<Product> Products;
        public static List<Customer> Customers { get; set; }

        static ListGeneratorHelpers()
        {
            ...
            //Customers = XDocument.Load("C:\\Users\\Mr Ali\\Downloads\\Data\\Customers.xml"); // مش ينفع اعمل كده علشان لو بعتت البروجكت لجهاز تاني ال path ده هيكون مش عنده ف مش هيشتغل 
